...
2. prendre un élément et le géolocaliser, soit en lui associant une
   adresse, soit par glisser-déposer sur un fond de carte.

On conserve la possibilité d'éléments qui ne sont pas dans la série
mais qui sont des points d'intérêt géographiques.
...
Pour le parcours temporel (la frise), on associe à chaque élément une
date de début et une date de fin, ceci permettant de construire la
frise.  Cette association se fait à la main dans des champs prévus à
cet effet.
