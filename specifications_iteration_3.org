...
pertinent.  La recommandation provisoire (en attente de validation de
l'Université) pour les contenus contribués est la licence [[http://creativecommons.org/licenses/by-nc-sa/3.0/fr/][CC-by-sa-nc]]
soit {1,0,1} pour dire "SA s'applique", "ND ne s'applique pas" et "NC
s'applique".

Si les deux champs sont incompatible, le champ "Droits d'auteur"
prime.
...
contributeur* : l'auteur est celui indiqué dans le champ "Droits
d'auteur" et le contributeur est l'utilisateur ayant importé ou ajouté
ce contenu.
...
Les collections (dossiers et parcours) sont les contenus collaboratifs
de la plate-forme.

Les utilisateurs peuvent ajouter des éléments à leurs dossiers en
fonction des droits de ces éléments.

Les éléments qu'on peut ajouter à un dossier sont :

- les éléments du domaine public ou
- les éléments dont on est l'auteur ou
